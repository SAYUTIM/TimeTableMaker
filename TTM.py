...
def Extract_TimeTable_Pdf(input_path, output_path):
    start_page = int(input("最初のページ番号を入力してください: "))
    end_page = int(input("最後のページ番号を入力してください: "))
...
Extract_TimeTable_Pdf(TimeTable_Pdf_Preset_Path, TimeTable_Pdf_Cache_Path)
